        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-2 text-xl text-gray-600 mb-8">
              ...
              <span>{formatDateTime(metadata.date, metadata.time)}</span>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <img
                src={metadata.host.image}
                alt={metadata.host.name}
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-6">
                {metadata.host.name} is an experienced orthodontic marketing expert who has helped hundreds of practices achieve remarkable growth through proven marketing strategies.
              </p>
              <p className="text-xl text-gray-600">
