...
export function ProcessStep({ icon: Icon, title, description, details, index }) {
  return (
    <motion.div
    ...
    >
      ...
      <h3 className='text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent'>{title}</h3>
