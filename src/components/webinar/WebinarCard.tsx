...
export function WebinarCard({ webinar }: WebinarCardProps) {
  return (
    <Link to={`/webinars/${webinar.slug}`} className="group">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center text-gray-600 mb-4">
            ...
            <span className="text-sm">
              {formatDateTime(webinar.date, webinar.time)}
            </span>
          </div>
          <div className="flex items-center space-x-3 mb-4">
            ...
            />
            <div>
              <p className="font-medium">{webinar.host.name}</p>
              <p className="text-sm text-gray-600">{webinar.host.title}</p>
            </div>
          </div>
